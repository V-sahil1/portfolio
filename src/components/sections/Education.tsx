      ...
      <div className="mx-auto mt-14 grid max-w-4xl gap-6">
        {education.map((item, i) => (
          <Reveal key={item.id} delay={i * 0.08}>
            <div className="glass flex flex-col gap-5 rounded-2xl p-6 sm:flex-row sm:items-center sm:gap-7 sm:p-7">
              <div className="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-xl bg-white p-2 dark:bg-white/10">
                <img
                  src={item.logo}
