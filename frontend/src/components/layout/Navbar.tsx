  ...
  return (
    ...
    >
      <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 sm:px-8 lg:px-12">
        ...
        >
          <span className="grid h-9 w-9 place-items-center rounded-lg border border-slate-300 font-mono text-sm text-brand-600 dark:border-white/[0.12] dark:text-brand-300">
            SV
          </span>
      ...
      <div
        className={cn(
          "glass-bar overflow-hidden transition-[max-height] duration-300 md:hidden",
